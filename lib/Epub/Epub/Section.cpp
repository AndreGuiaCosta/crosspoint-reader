...
// The number itself lives in Section.h so PageFlip's compatibility hash can name the same layout
// epoch without copying it; bump it there and this history keeps its one home.
constexpr uint8_t SECTION_FILE_VERSION = Section::FILE_VERSION;
