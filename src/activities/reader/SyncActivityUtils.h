...
// ~55KB and the C3 doesn't have that to spare while they're held. On this
// branch that means the font glyph caches (tens of KB with an SD .cpfont
// after a reader session); they reload on demand at the next render.
