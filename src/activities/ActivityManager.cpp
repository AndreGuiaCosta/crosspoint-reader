...
#include "browser/ReadestLibraryActivity.h"
...
void ActivityManager::goToReadestLibrary() {
  replaceActivity(std::make_unique<ReadestLibraryActivity>(renderer, mappedInput));
}
...
void ActivityManager::goHome(HomeMenuItem initialMenuItem) {
  if (initialMenuItem == HomeMenuItem::NONE && currentActivity) {
    ...
    } else if (activityName == "ReadestLibrary") {
      initialMenuItem = HomeMenuItem::READEST_LIBRARY;
